...
---
## Basic Information on Osteporosis

Before, I dive deep into my analysis, I want to give you an idea on the basic terminoligies used in this analysis.

Osteopororis is a condition in which bones become brittle and are prone to breaking.
BMD refers to Bone Mineral desnity and BMC refers to Bone Mineral Content.
...
1. **Data Cleaning**: For my analysis I used the NHANES data from the categories of demographics, examination and questionarie. All relevant the data from these categories were chosen for the analysis of Osteoporosis specifically in the spine region. Then I combined all the data, and treated the data for missing values using the mice library.

2. **Statistical Analysis**: I performed several types of statistical tests, including paired and independent t-tests, to compare the impact/relevance of bone parameters between osteoporosis affected patient versus a patient without osteoporosis. I also built linear regression models to predict Bone Mineral Density (BMD) based on various factors.
...
The analysis confirmed what one might conclude intuitively, people with osteoporosis history will have low bone mineral desnity, and bone mineral content. Also, the relationship between bone mineral density and bone mineral content is positively correlated. This makes sense too. Females are more prone to oseteoporosis than men. This conclusion is significant for the sample that I worked with.

---

## Personal Reflection

Building this dashboard was challenging to me, as I don't have any prior experience working with it. Figuring out my way in understanding the different components and ways to implement was both challenging and exciting. But, in the end I learnt a lot and I am looking forward to creating more such useful tools to publish my personal rsearch analysis.

I would extend this study to incorporate the effects of genetics in getting affected by osteoporosis. Also, this is specific to spine, I would like to include other bone types for my future analysis.
